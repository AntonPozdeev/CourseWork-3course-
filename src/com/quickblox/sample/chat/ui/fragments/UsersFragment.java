        ...
        createChatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	try {
					...
					Toast.makeText(getActivity(), "erooooor1:" + e.toString(), Toast.LENGTH_LONG).show();
					return;
				}
                    ...
                    public void onSuccess(QBDialog dialog, Bundle args) {
                        if(usersAdapter.getSelected().size() == 1){
                        	try{
                        		...
                        		Toast.makeText(getActivity(), "Error with create Single new chat" + ex.toString(),
                        	...
                        	try{
                        		...
                        		Toast.makeText(getActivity(), "Error with create Group new chat" + ex.toString(),
                        				Toast.LENGTH_SHORT).show();
                        	}
                        }
                    }
